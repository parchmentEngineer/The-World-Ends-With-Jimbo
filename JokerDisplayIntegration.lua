...
jd_def["j_twewy_flamesApart"] = {
    ...
    calc_function = function(card)
        ...
        card.joker_display_values.active = text ==
            ("Straight Flush" or "Flush House" or "Flush Five" or "Five of a Kind") and true or false
...
jd_def["j_twewy_webSpider"] = {
    ...
    calc_function = function(card)
        ...
        card.joker_display_values.xMult = text and G.GAME.hands[text] and (G.GAME.hands[text].level == 2) and
...
jd_def["j_twewy_lolitaChopper"] = {
    ...
    calc_function = function(card)
        ...
        card.joker_display_values.most_played_hand = all_equal and "All" or
            (multiple_most_played and "Multiple" or tostring(most_played_hand[1]))
    end
}
